...
class DecaRecognitionException extends RecognitionException {
    ...
    public DecaRecognitionException(String message, AbstractDecaLexer recognizer, IntStream input) {
        super(message, recognizer, input, null);
        location = new Location(recognizer.getLine(), recognizer.getCharPositionInLine(), recognizer.getSourceName());
        setOffendingToken(recognizer.getToken());
    }
    ...
    public DecaRecognitionException(String message, DecaParser recognizer, ParserRuleContext ctx) {
