...
public class MethodDefinition extends ExpDefinition {
    ...
    /** The EnvironmentExp of the method */
    private EnvironmentExp methodEnvExp;

    /**
     * Get the EnvironmentExp of the method
     *
     * @return The EnvironmentExp of the method
     */
    public EnvironmentExp gEnvironmentExp() {
        return methodEnvExp;
    }

    /**
     * Set the EnvironmentExp of the method
     *
     * @param methodEnvExp the EnvironmentExp to be set for the method
     */
    public void setEnvironmentExp(EnvironmentExp methodEnvExp) {
